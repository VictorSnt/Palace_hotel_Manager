    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='accommodations', to='hotel_palace.room')),
            ],
        ),
        migrations.CreateModel(
            name='ProductConsume',
            fields=[
                ...
                ('room_reservation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='consumes', to='hotel_palace.roomaccommodation')),
            ],
        ),
        migrations.AddField(
            model_name='room',
