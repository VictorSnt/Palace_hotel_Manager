    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservation', to='hotel_palace.room')),
            ],
        ),
        migrations.AddField(
            model_name='room',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hotel_palace.roomcategory'),
        ),
        migrations.CreateModel(
            name='RoomReservation',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('guest_quant', models.CharField(choices=[('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], default='1', max_length=10)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('costumer_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hotel_palace.customer')),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservations', to='hotel_palace.room')),
            ],
        ),
        migrations.CreateModel(
            name='ProductConsume',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hotel_palace.product')),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hotel_palace.room')),
                ('room_reservation_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='consumes', to='hotel_palace.roomreservation')),
            ],
        ),
    ]
